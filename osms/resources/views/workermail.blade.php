...
<div class="container">
    <table class="table">
     ...
     <tr>
      <th>Print Pdf:-</th>
      <td><a href="{{ route('pdf', ['id' => $data->id]) }}" style="cursor: pointer; border-radius:8px; background:lawngreen; border:2px solid rgb(255, 0, 0); outline:none; padding:6px;">Print</a></td>
     </tr>
    </table>
</div>
</body>
